...
public record CouncilNoticeResponse(
    ...
    @Schema(description = "공지사항 생성 일시", example = "2025.12.03 10:30:00", requiredMode = REQUIRED)
    @JsonFormat(pattern = "yyyy.MM.dd HH:mm:ss")
    LocalDateTime createdAt,

    @Schema(description = "공지사항 수정 일시", example = "2025.12.03 10:30:00", requiredMode = REQUIRED)
    @JsonFormat(pattern = "yyyy.MM.dd HH:mm:ss")
